...
const SignInPage = () => {
  ...
  return (
    <div className="flex gap-0  lg:gap-10 lg:bg-[#ffffff] md:bg-[#ffffff] bg-[#ffffff] justify-center items-center min-h-screen">
      {/* Left side - Image */}
      {renderImage()}
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 text-black "
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 text-black"
                    required
                  />
